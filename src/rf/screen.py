import pygame
from rf.images import start_menu, game_over, car_icon
...
class Screen:
    ...
    def startEngine(self):
        ...
        icon = pygame.image.load(car_icon)
        pygame.display.set_icon(icon)

        return DISPLAY, clock

    def startScreen(self):
        menu_image = pygame.image.load(start_menu)
        self.displayScreen(menu_image)

    def endScreen(self):
        menu_image = pygame.image.load(game_over)
        self.displayScreen(menu_image)
